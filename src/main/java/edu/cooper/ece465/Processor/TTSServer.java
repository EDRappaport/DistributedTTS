...
/** A bare-bones Server containing a ServerSocket waiting for connection requests. Subclasses should implement the
 * <code>spawnProtocolHandler</code> method. */
public abstract class TTSServer implements Runnable {


	/** Implements the run() method of Runnable interface. It starts a ServerSocket, listens for connections, and spawns a
	...
	/** This method is called after a connection request is made to this TTSServer. The <code>Socket</code> created as a
